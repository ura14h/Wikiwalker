...
記事を 3D 空間に星として配置し、意味的に近い記事、本文からの出リンク、その記事を参照している被リンクを辿りながら知識のつながりを眺められます。大量のリンク先は共有カテゴリごとの「星団」に集約して表示します。
...
- 記事詳細パネルの最下段に、集約したカテゴリ数、その他の関連記事数、出リンク数、被リンク数が表示されます
